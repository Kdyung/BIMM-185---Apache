...
#    Step 1: Generate DAVID output files
    ...
    demofilename = 'DAVID_py/list1.txt'
...
#   Cytoscape instruction data
    ...
    DAVIDenrich(listF = infilename, idType = 'GENE_SYMBOL', listName = '12hrname', category = 'abcd,BBID,BIOCARTA,COG_ONTOLOGY,INTERPRO,KEGG_PATHWAY,OMIM_DISEASE,PIR_SUPERFAMILY,SMART,SP_PIR_KEYWORDS,UP_SEQ_FEATURE')
    return
